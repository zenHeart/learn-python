...
# (train_images, train_labels), (test_images, test_labels) = mnist.load_data()
</code></pre><div class="py-demo-output">Click Run to see output</div></div><blockquote><p>⚠️ 本教程使用 Pyodide（浏览器端 Python），不包含 TensorFlow。如需运行真正的 MNIST 示例，请在本地 <code>pip install tensorflow</code> 后执行。</p></blockquote><hr><h2 id="下节预告" tabindex="-1">下节预告 <a class="header-anchor" href="#下节预告" aria-label="Permalink to &quot;下节预告&quot;">​</a></h2><p>→ <a href="/learn-python/tutorial/types.html">L2 数据类型</a></p>`,42)])])}const m=e(s,[["render",d]]);export{h as __pageData,m as default};
